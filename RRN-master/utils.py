##
# @file utils.py
# @brief Utility funcitons for the model. Nothing changed to the original code from the paper
...
def mkdir_if_missing(directory):
    """! As the name implies, takes an directory path and creates it if it doesnt exist.
    @param directory  Directory to check if it exists and to create if it doesn't
    """
...
class Logger(object):
    """! Main logging class of this project.  
